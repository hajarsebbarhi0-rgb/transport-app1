...
export default function Profile() {
  ...
  const fetchProfile = async () => {
    try {
      ...
      // Pré-remplir les champs si la valeur existe
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.infoContainer}>
        ...
        <TouchableOpacity style={styles.homeButton} onPress={() => router.push("eleve/index")}>
...
const styles = StyleSheet.create({
  ...
  photoButton: { marginTop: 10, backgroundColor: "#1e90ff", paddingVertical: 8, paddingHorizontal: 20, borderRadius: 20 },
  ...
  saveButton: { backgroundColor: "#32cd32", padding: 12, borderRadius: 25, marginTop: 10, alignItems: "center" },
  saveButtonText: { color: "#fff", fontWeight: "bold", fontSize: 16 },
  homeButton: { backgroundColor: "#1e90ff", padding: 12, borderRadius: 25, marginTop: 15, alignItems: "center" },
