import { Feather } from "@expo/vector-icons"; // ✅ pour l’icône crayon
...
export default function Profile() {
  ...
  const [isEditing, setIsEditing] = useState(false); // ✅ nouveau : mode édition ou pas
  ...
  const pickImage = async () => {
    if (!isEditing) return; // ✅ impossible de modifier la photo si pas en mode édition
  ...
  const updateProfile = async () => {
    ...
    try {
      ...
      setIsEditing(false); // ✅ repasse en mode lecture
    } catch (error) {
