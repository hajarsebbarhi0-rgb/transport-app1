...
import { COLORS } from "../theme"; // ⚡ thème bleu/jaune
  ...
  if (loading) {
    return (
      <View style={styles.center}>
        ...
        <Text style={{ color: COLORS.text, marginTop: 10 }}>Chargement du profil...</Text>
      </View>
    );
  }
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={[styles.infoContainer, { backgroundColor: COLORS.card }]}>
        ...
        <TextInput style={[styles.input, { color: COLORS.text }]} value={email} onChangeText={setEmail} editable={isEditing} keyboardType="email-address" />

        <Text style={[styles.label, { color: COLORS.textSecondary }]}>Téléphone :</Text>
        <TextInput style={[styles.input, { color: COLORS.text }]} value={telephone} onChangeText={setTelephone} editable={isEditing} keyboardType="phone-pad" />
