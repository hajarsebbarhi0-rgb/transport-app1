...
const RegisterScreen = () => {
  ...
  const handleRegister = async () => {
    ...
    setIsLoading(true);
    try {
      await axios.post('http://192.168.152.1:8000/api/register', {
        email,
        password,
        nom,
        prenom,
...
const styles = StyleSheet.create({
  ...
  pickerContainer: { width: '100%', borderWidth: 1, borderColor: '#d5d8d6', borderRadius: 10, marginBottom: 20, backgroundColor: '#fff' },
