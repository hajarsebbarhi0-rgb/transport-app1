import { Picker } from '@react-native-picker/picker'; // Installer: npm install @react-native-picker/picker
...
const styles = StyleSheet.create({
  ...
  input: { width: '100%', padding: 15, borderWidth: 1, borderColor: '#d5d8d6', marginBottom: 20, borderRadius: 10, fontSize: 16, color: '#4a8e9e', backgroundColor: '#fff' },
  pickerContainer: { width: '100%', borderWidth: 1, borderColor: '#d5d8d6', borderRadius: 10, marginBottom: 20, overflow: 'hidden' },
  picker: { width: '100%' },
  registerButton: { backgroundColor: '#b13623', padding: 18, borderRadius: 10, width: '100%', alignItems: 'center' },
