...
export default function Profile() {
  ...
  const pickImage = async () => {
    ...
    if (!pickerResult.canceled) {
      ...
      try {
        const response = await axios.post("http://192.168.200.1:8000/api/eleve/photo", formData, {
          headers: {
...
const styles = StyleSheet.create({
  ...
  saveButton: { backgroundColor: "#b13623", padding: 12, borderRadius: 25, marginTop: 10, alignItems: "center" },
